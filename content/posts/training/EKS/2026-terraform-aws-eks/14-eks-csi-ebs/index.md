...
---
{{< lead >}}
AWS **EBS Container Storage Interface (CSI)** driver allows **EKS Clusters** to manage the **lifecycle** of [EBS]({{< ref "aws/2025-aws-cloud-practitioner/6-storage/#ebs-volume" >}}) volumes for persistent volumes in k8s (Create / Resize / Delete volumes).
{{< /lead >}}
