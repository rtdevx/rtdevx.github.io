...
| [Internet Gateway]({{< ref "18-vpc/#internet-gateway--nat-gateways" >}}) / Egress-only Internet Gateway | The Amazon VPC side of a connection to the public internet for IPv4/IPv6                                                      |
| Router                                                                                                  | Routers interconnect subnets and direct traffic between internet gateways, virtual private gateways, NAT gateways and subnets |
| [Peering Connection]({{< ref "18-vpc/#vpc-peering" >}})                                                 | Direct connection between two VPC's                                                                                           |
| [VPC Endpoints]({{< ref "18-vpc/#vpc-endpoints" >}})                                                    | Private Connection to public AWS services                                                                                     |
| NAT Instance                                                                                            | Enables Internet access for EC2 instances in private subnets (managed by you)                                                 |
| [NAT Gateway]({{< ref "18-vpc/#internet-gateway--nat-gateways" >}})                                     | Enables Internet access for EC2 instances in private subnets (managed by AWS)                                                 |
| Virtual Private Gateway                                                                                 | The Amazon VPC side of a Virtual Private Network ([VPN]({{< ref "18-vpc/#site-to-site-vpn--direct-connect" >}})) connection   |
| Customer Gateway                                                                                        | Customer side of a [VPN]({{< ref "18-vpc/#site-to-site-vpn--direct-connect" >}}) connection                                   |
